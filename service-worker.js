const CACHE = 'pokebinder-v22';
const APP_FILES = ['./', './index.html', './styles.css', './install.css', './auth.css', './catalog.css', './collection-library.css', './quantity.css', './hero-showcase.css', './app.js', './supabase-client.js', './supabase/config.js', './manifest.webmanifest', './icon.svg'];
